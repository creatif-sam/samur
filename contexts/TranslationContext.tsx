...
export const translations = {
  en: {
    ...
    prayer: {
      title: 'Prayer',
      todayCard: 'Have you prayed today?',
      prayedToday: 'Prayer done',
      markPrayed: 'Mark as Prayed',
      streak: 'day streak',
      duration: 'Duration',
      notePlaceholder: 'What did you bring before God today? (optional)',
      saveNote: 'Save note',
      requests: 'Prayer Requests',
      addRequest: 'Add',
      noRequests: 'No active prayer requests.',
      addFirst: 'Add your first one',
      answeredTitle: 'Answered Prayers',
      answered: 'Answered',
      remove: 'Remove',
      newRequest: 'New Prayer Request',
      requestPlaceholder: 'What are you bringing before God?',
      detailsPlaceholder: 'More details (optional)',
      category: 'Category',
      sharePartner: 'Share with partner',
      addRequestBtn: 'Add Request',
      markAnswered: 'Prayer Answered!',
      testimonyPlaceholder: 'How was it answered? (optional — write your testimony)',
      markAnsweredBtn: 'Mark Answered',
      categories: {
        personal: 'Personal',
        family: 'Family',
  ...
  fr: {
    ...
    prayer: {
      title: 'Priere',
      todayCard: 'As-tu prie aujourd\'hui?',
      prayedToday: 'Priere faite',
      markPrayed: 'Marquer comme prie',
      streak: 'jours consecutifs',
      duration: 'Duree',
      notePlaceholder: 'Qu\'as-tu apporte devant Dieu aujourd\'hui? (optionnel)',
      saveNote: 'Sauvegarder la note',
      requests: 'Intentions de priere',
      addRequest: 'Ajouter',
      noRequests: 'Aucune intention de priere active.',
      addFirst: 'Ajouter la premiere',
      answeredTitle: 'Prieres exaucees',
      answered: 'Exaucee',
      remove: 'Supprimer',
      newRequest: 'Nouvelle intention de priere',
      requestPlaceholder: 'Qu\'apportez-vous devant Dieu?',
      detailsPlaceholder: 'Plus de details (optionnel)',
      category: 'Categorie',
      sharePartner: 'Partager avec le partenaire',
      addRequestBtn: 'Ajouter',
      markAnswered: 'Priere exaucee!',
      testimonyPlaceholder: 'Comment a-t-elle ete exaucee? (optionnel)',
      markAnsweredBtn: 'Marquer comme exaucee',
      categories: {
        personal: 'Personnel',
        family: 'Famille',
        intercession: 'Intercession',
